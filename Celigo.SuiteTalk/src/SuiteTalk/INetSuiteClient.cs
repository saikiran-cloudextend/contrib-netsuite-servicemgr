...
#pragma warning disable IDE1006 // Naming Styles
        ...
        Task<SearchResult> searchAsync(SearchRecord searchRecord,
...
#pragma warning restore IDE1006 // Naming Styles
    ...
    public partial class NetSuitePortTypeClient : INetSuiteClient
    {
        ...
        public virtual async Task<SearchResult> searchAsync(
            SearchRecord searchRecord, SearchPreferences searchPref)
        {
        ...
        public virtual async Task<SearchResult> search(
            SearchRecord searchRecord)
        {
